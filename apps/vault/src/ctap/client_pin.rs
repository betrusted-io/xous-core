...
impl ClientPin {
    ...
    pub fn new_test(
        ...
        let (key_agreement_key_v1, key_agreement_key_v2) = match pin_uv_auth_protocol {
            PinUvAuthProtocol::V1 => (key_agreement_key, ctap_crypto::ecdh::SecKey::gensk(env.rng())),
        ...
        pin_uv_auth_token_state.begin_using_pin_uv_auth_token(Instant::new(0));
        ClientPin {
...
mod test {
    ...
    fn test_helper_process_change_pin(pin_uv_auth_protocol: PinUvAuthProtocol) {
        ...
        assert_eq!(
            client_pin.process_command(&mut env, bad_params, Instant::new(0)),
            Err(Ctap2StatusCode::CTAP2_ERR_PIN_AUTH_INVALID)
        );
    ...
    fn test_helper_process_get_pin_token(pin_uv_auth_protocol: PinUvAuthProtocol) {
        ...
        let response = client_pin
            .process_command(&mut env, params.clone(), Instant::new(0))
            .unwrap();
    ...
    fn test_verify_pin_uv_auth_token() {
        ...
        client_pin
            .pin_uv_auth_token_state
            .begin_using_pin_uv_auth_token(Instant::new(0));
    ...
    fn test_update_timeouts() {
        ...
        assert!(client_pin
            .process_command(&mut env, params, Instant::new(0))
            .is_ok());
        for permission in PinPermission::into_enum_iter() {
            assert_eq!(
                client_pin
        ...
        let timeout = Instant::new(0) + Duration::from_millis(30001_u32);
