...
use ctap_crypto::hkdf::hkdf_empty_salt_256;
#[cfg(test)]
use ctap_crypto::hmac::hmac_256;
use ctap_crypto::hmac::{verify_hmac_256, verify_hmac_256_first_128bits};
...
impl PinProtocol {
    ...
    pub fn decapsulate(
        ...
        let pk: ctap_crypto::ecdh::PubKey = CoseKey::try_into(peer_cose_key)?;
...
pub struct SharedSecretV1 {
    common_secret: [u8; 32],
    aes_enc_key: ctap_crypto::aes256::EncryptionKey,
}
...
impl SharedSecretV1 {
    ...
    fn new(handshake: [u8; 32]) -> SharedSecretV1 {
        ...
        let aes_enc_key = ctap_crypto::aes256::EncryptionKey::new(&common_secret);
        SharedSecretV1 {
            common_secret,
            aes_enc_key,
        }
...
impl SharedSecretV2 {
    ...
    fn new(handshake: [u8; 32]) -> SharedSecretV2 {
        ...
        SharedSecretV2 {
            aes_enc_key: ctap_crypto::aes256::EncryptionKey::new(&aes_key),
