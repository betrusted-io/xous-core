...
/// derived from a blend of entropy sources.
pub const SYS_BOOT_SETUP_DONE: usize = 84;
...
pub const SERIAL_NUMBER: SlotIndex = SlotIndex::Data(0, PartitionAccess::All);
...
pub const UUID: SlotIndex = SlotIndex::Data(1, PartitionAccess::All);
...
pub const IFR_HASH: SlotIndex = SlotIndex::Data(2, PartitionAccess::All);
