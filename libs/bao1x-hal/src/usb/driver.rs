...
impl CorigineUsb {
    ...
    pub fn reset(&mut self) {
        ...
        INFO:bao1x_hal::usb::driver: devcap: 20014401 (libs/bao1x-hal/src/usb/driver.rs:781)
        INFO:bao1x_hal::usb::driver: max speed: 1 (libs/bao1x-hal/src/usb/driver.rs:782)
        INFO:bao1x_hal::usb::driver: usb3 disable: 8 (libs/bao1x-hal/src/usb/driver.rs:783)
         */
    ...
    /*
     ...
     These are mostly dummy thunks on the bao1x target because only a single core is possible
     on this SoC.
