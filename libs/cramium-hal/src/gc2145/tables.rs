...
*/
use crate::gc2145::constants::*;

pub(crate) const GC2145_INIT: [[u8; 2]; 607] = [
    [0xfe, 0xf0],
    [0xfe, 0xf0],
    [0xfe, 0xf0],
    [0xfc, 0x06],
    ...
    [0x12, 0x2e],
    [0x17, 0x14 | 0x00], /* Analog Mode 1 (vflip/mirror[1:0]) */
...
pub(crate) const GC2145_INIT_2: [[u8; 2]; 633] = [
    [0xfe, 0xf0],
    [0xfe, 0xf0],
    [0xfe, 0xf0],
    [0xfc, 0x06],
...
pub(crate) const GC2145_INIT_3: [[u8; 2]; 673] = [
    [0xfe, 0xf0],
    [0xfe, 0xf0],
    [0xfe, 0xf0],
    [0xfc, 0x06],
...
pub(crate) const GC2145_AEC: [[u8; 2]; 35] = [
    [0xfe, 0x00],
    [0x03, 0x04], // default exposure msb
    [0x04, 0xe2], // default exposure lsb
    [0xfe, 0x01],
    [0x01, 0x04],
    [0x02, 0xc0],
    [0x03, 0x04],
