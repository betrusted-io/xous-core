...
use utralib::*;
// save some typing
const BLOCK_LEN: usize = <crate::Sha512 as BlockSizeUser>::BlockSize::USIZE;
...
pub fn compress512(csr: &mut CSR<u32>, blocks: &[[u8; 128]]) { compress(csr, blocks) }
...
fn compress(csr: &mut CSR<u32>, blocks: &[[u8; BLOCK_LEN]]) {
    ...
    for block_chunk in blocks.chunks(BUF_BLOCKS) {
        ...
        // set function
        csr.wfo(utra::combohash::SFR_CRFUNC_CR_FUNC, HashFunction::Sha512 as u32);
        // endianness swap
        csr.wo(
