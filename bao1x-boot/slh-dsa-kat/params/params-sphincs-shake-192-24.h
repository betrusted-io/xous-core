...
/* NIST SP 800-230 (ipd) limited-signature parameter set: params-sphincs-shake-192-24
 * 2^24 signature limit per signing key. d=1 (single-layer hypertree),
 * adjusted Winternitz parameter w=8. */

#define SPX_NAMESPACE(s) SPX_##s

#define SPX_N 24
#define SPX_FULL_HEIGHT 21
#define SPX_D 1
#define SPX_FORS_HEIGHT 25
