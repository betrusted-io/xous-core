...
use dc34_vault::ctap::hid::{ChannelID, CtapHidCommand, Message, send::HidPacketIterator};
use dc34_vault::vault_api::{COMMAND_BACKUP_TOTP_CODES, COMMAND_RESET_SESSION, COMMAND_RESTORE_TOTP_CODES};
use locales::t;
