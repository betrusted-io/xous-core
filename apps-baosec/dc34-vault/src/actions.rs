    ...
    pub(crate) fn acquire_qr(&mut self) {
        ...
        if let Some(qr_uri) = qr_data.content {
            ...
            /*
                ...
                - time://2025-11-27T13:06:02+08:00
                    - set RTC offset
                - pin://<base64 PIN>
                    - Use this as the PIN value for the token
                ...
                - search://<string to search>?time=2025-11-27T13:06:02+08:00
            ...
            */
            ...
            xous::send_message(
                self.main_conn,
                xous::Message::new_scalar(VaultOp::AbortQr.to_usize().unwrap(), 0, 0, 0, 0),
            )
            .ok();
        }
    }
