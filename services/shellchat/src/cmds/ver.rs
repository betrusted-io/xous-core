        ...
        if let Some(sub_cmd) = tokens.next() {
            match sub_cmd {
                "ec" => {
                    ...
                    log::info!("{}ECREV,{},{},{},{},{}", xous::BOOKEND_START, maj, min, rev, commit, xous::BOOKEND_END);
                ...
                "soc" => {
                    ...
                    log::info!("{}SOCREV,{},{},{},{},{}", xous::BOOKEND_START, maj, min, rev, gitrev, xous::BOOKEND_END);
                }
                "dna" => {
                ...
                "xous" => {
                    ...
                    log::info!("{}XOUSREV,{},{}", xous::BOOKEND_START, env.ticktimer.get_version(), xous::BOOKEND_END);
                }
                _ => {
