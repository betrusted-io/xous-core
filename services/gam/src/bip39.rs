...
mod tests {
    ...
    fn test_11_to_8() {
        ...
        // 0000_0110|001/1_0110|0111_10/01|1100_1010_0/001_10110010 10001011010 11100111111 01101010011 10000011000 01101011001 10110011111 10001001110 00111100110
        // 0000_0110 0011_0110  0111_1001 1100_1010 ... 0001101100101000101101011100111111011010100111000001100001101011001101100111111000100111000111100110
    ...
    fn test_bip39_to_bytes() {
        let phrase = vec![
            "alert".to_string(), "record".to_string(), "income".to_string(), "curve".to_string(),
            "mercy".to_string(), "tree".to_string(), "heavy".to_string(), "loan".to_string(),
            "hen".to_string(), "recycle".to_string(), "mean".to_string(), "devote".to_string()
        ];
        let refnum = 0b00000110001101100111100111001010000110110010100010110101110011111101101010011100000110000110101100110110011111100010011100011110u128;
        let mut refvec = refnum.to_be_bytes().to_vec();
        // refvec.push(6); // checksum
