...
impl LayoutApi for Framebuffer {
    ...
    fn get_gids(&self) -> Vec<crate::api::GidRecord> {
        vec![crate::api::GidRecord { gid: self.gid, canvas_type: CanvasType::Framebuffer }]
    }
