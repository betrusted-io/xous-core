...
impl ChatLayout {
    ...
    pub fn init(
        ...
        let predictive_canvas = Canvas::new(
            ...
            &trng,
            None,
            crate::api::CanvasType::ChatPreditive,
        )
        ...
        let input_canvas = Canvas::new(
            ...
            &trng,
            None,
            crate::api::CanvasType::ChatInput,
        )
        ...
        let content_canvas = Canvas::new(
            ...
            (MISC_CONTEXT_DEFAULT_TRUST - TRUST_OFFSET) / 2,
            &trng,
            None,
            crate::api::CanvasType::ChatContent,
        )
...
impl LayoutApi for ChatLayout {
    fn behavior(&self) -> LayoutBehavior { LayoutBehavior::App }
    ...
    fn resize_height(
        ...
        if (new_content_rect.br.y - new_content_rect.tl.y) > self.min_content_height {
            ...
            {
                let content_canvas_mut =
                    canvases.get_mut(&self.content).expect("couldn't find content canvas");
                content_canvas_mut.set_clip(new_content_rect);
                new_content_rect.style =
                    DrawStyle { fill_color: Some(PixelColor::Light), stroke_color: None, stroke_width: 0 };
    ...
    fn get_gids(&self) -> Vec<crate::api::GidRecord> {
        vec![
            crate::api::GidRecord { gid: self.content, canvas_type: crate::api::CanvasType::ChatContent },
            crate::api::GidRecord { gid: self.input, canvas_type: crate::api::CanvasType::ChatInput },
            crate::api::GidRecord {
                gid: self.predictive,
