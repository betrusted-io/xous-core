...
fn xmain() -> ! {
    ...
    let llio_sid = xns.register_name(api::SERVER_NAME_LLIO, Some(5)).expect("can't register server");
    ...
    let i2c_sid = xns.register_name(api::SERVER_NAME_I2C, Some(5)).expect("can't register I2C thread");
