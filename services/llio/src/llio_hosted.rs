...
impl Llio {
    pub fn new(_handler_conn: xous::CID, _gpio_base: *mut u32) -> Llio { Llio {} }
    ...
    pub fn power_crypto_status(&self) -> (bool, bool, bool, bool) { (true, true, true, true) }
    ...
    pub fn xadc_vccint(&self) -> u16 { 1296 }

    pub fn xadc_vccaux(&self) -> u16 { 2457 }

    pub fn xadc_vccbram(&self) -> u16 { 2450 }

    pub fn xadc_usbn(&self) -> u16 { 3 }

    pub fn xadc_usbp(&self) -> u16 { 4 }

    pub fn xadc_temperature(&self) -> u16 { 2463 }

    pub fn xadc_gpio5(&self) -> u16 { 0 }

    pub fn xadc_gpio2(&self) -> u16 { 0 }
    ...
    #[allow(dead_code)]
    pub fn activity_get_period(&mut self) -> u32 { 12_000_000 }
    ...
    pub fn get_power_csr_raw(&self) -> u32 { 0 }
}
