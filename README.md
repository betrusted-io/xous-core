...
- Dabao with USB CCID: `cargo xtask dabao-ccid` (flash archives: `images/dabao-ccid/known-good/` and `images/dabao-ccid/openpgp-apdu/`; see [README-baochip.md](./README-baochip.md))
