...
extern crate ed25519_dalek_loader;
extern crate hex;
extern crate rand;
#[cfg(all(test, feature = "serde"))]
...
use ed25519_dalek_loader::*;

use hex::FromHex;

#[cfg(test)]
mod vectors {
    use curve25519_dalek_loader::{edwards::EdwardsPoint, scalar::Scalar};
    ...
    #[test]
    fn repudiation() {
        use curve25519_dalek_loader::traits::IsIdentity;
        use std::ops::Neg;
