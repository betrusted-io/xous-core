...
pub const GUARD_MEMORY_BYTES: usize = 10 * crate::PAGE_SIZE;
#[cfg(all(feature = "swap", not(feature = "resume"), feature = "bao1x"))]
pub const GUARD_MEMORY_BYTES: usize = 11 * crate::PAGE_SIZE;
/// Amount of space for loader stack plus clean suspend, with swap. +1 page cost for the loading bar graphics.
/// +2 for sig verification in loader
#[cfg(all(feature = "swap", feature = "resume"))]
pub const GUARD_MEMORY_BYTES: usize = 12 * crate::PAGE_SIZE; // 1 extra page for clean suspend
