...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let base_pkgs_remote = [
        "xous-log@0.1.21",         // "well known" service: debug logging
        "xous-names@0.9.30",      // "well known" service: manage inter-server connection lookup
        "xous-susres@0.1.26",     // ticktimer registers with susres to coordinate time continuity across sleeps
        "xous-ticktimer@0.1.25",   // "well known" service: thread scheduling
    ].to_vec();
