...
Branch: dev  
Reference implementation: https://github.com/Supermagnum/Galdralag-firmware
...
- Host triple checks confirm new modules type-check and Galdralag
...
- `Cargo.lock` — Dependency resolution updates for Galdr / CCID graph.
- `libs/baochip-openpgp/Cargo.toml` — New shim crate: in-tree HAL/TRNG paths,
  `[lib]` points at sibling Galdralag `src/lib.rs`.
