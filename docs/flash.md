...
+ 2027_5FFF |                                        |
+-----------+----------------------------------------+
+ 2027_5000 |   FPGA descriptive metadata area       |
+ 2027_5FFF |                                        |
+-----------+----------------------------------------+
+ 2027_6000 |   csr.csv corresponding to bitstream   |
+ 2027_DFFF |   (32kiB max, see below)               |
+-----------+----------------------------------------+
+ 2027_E000 |   FPGA digital signature page          |
+ 2027_FFFF |   + Opentimestamp record               |
+-----------+----------------------------------------+
+ 2028_0000 |   Incoming FPGA update staging  area   |
+ 204F_FFFF |                                        |
+-----------+----------------------------------------+
+ 2050_0000 |  Loader top 0x2000 is signature record |
+ 2051_FFFF |  0x2050_2000: loader.bin - Xous loader |
+-----------+----------------------------------------+
