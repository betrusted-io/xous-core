...
const PRODUCT: &'static str = "Baosec-Baremetal";
#[cfg(not(feature = "board-baosec"))]
const PRODUCT: &'static str = "Dabao-Baremetal";

impl DeviceDescriptor {
    pub fn default_usb_acm() -> Self {
        Self {
            b_length: core::mem::size_of::<Self>() as u8,
            b_descriptor_type: USB_DT_DEVICE,
            b_cd_usb: 0x0200,
            b_device_class: 0x00, // Per-interface classification
...
// Writes FS config into ep0_buf and returns the byte count
